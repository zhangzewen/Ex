...
struct rbtree_st{
	...
	struct rbtree_node_st* (*search)(uintptr_t key, void *data, struct rbtree_node_st *root);
...
struct rbtree_node_st *rb_search(uintptr_t key, void* data, struct rbtree_node_st *root);
